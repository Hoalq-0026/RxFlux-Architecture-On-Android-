 ...
 * RxFlux dispatcher, contains the registered actions. stores and the instance of the RxBus responsible to send
 * events to the stores.This class is used as a singleton.
 */
